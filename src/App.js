  ...
  return (
    <div className="App">
      ...
      <meta
        ...
        <h3 class="about-me">When I'm not coding, I like to <a href="https://www.instagram.com/sansmaps/">write <Emoji symbol="✍🏼" label="writing"/>
</a> and take <a href="https://www.instagram.com/nagmak.jpg/">photos <Emoji symbol="📷" label="camera"/></a>!</h3>
      </header>
      <body>
      <a className="arrow" href="#projects">
        ...
        <section className="contact">
          <a className="font-brand" href="https://twitter.com/__nagma__">
